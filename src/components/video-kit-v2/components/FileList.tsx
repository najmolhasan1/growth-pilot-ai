...
export default function FileList({ uploads, selectedId, onSelect, onDelete }: FileListProps) {
  ...
  return (
    <div id="file-list-card" className="flex h-full flex-col rounded-3xl border border-slate-200 bg-white p-4 font-sans shadow-sm sm:p-6">
      <div className="mb-6 flex flex-col justify-between gap-4 lg:flex-row lg:items-start">
        ...
        <div className="flex w-full items-center overflow-x-auto rounded-xl border border-slate-200/50 bg-slate-100 p-1 sm:w-auto lg:self-auto">
          <button
            type="button"
          ...
          <button
            ...
            className={`flex cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-lg px-3.5 py-1.5 text-xs font-semibold transition-all ${
              fileFilter === 'video'
                ? 'bg-white text-blue-600 shadow-xs'
      ...
      <div id="library-list" className="max-h-[420px] flex-1 space-y-3 overflow-y-auto pr-1">
          ...
          filteredUploads.map((u) => {
            ...
            return (
              <div
                ...
                className={`group relative flex cursor-pointer items-center justify-between rounded-2xl border p-3.5 transition-all sm:p-4 ${
                  isSelected 
                    ? 'border-blue-500 bg-blue-50/20 ring-1 ring-blue-500' 
                    : 'border-slate-150 hover:border-slate-250 hover:bg-slate-50/50'
                }`}
              >
                <div className="flex min-w-0 items-start space-x-3.5 pr-3 sm:pr-6">
